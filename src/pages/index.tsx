...
const Login = () => {
  return (
    <div className={`grid lg:grid-cols-2`}>
      ...
      <section className={`w-9/12 mx-auto pt-8 flex flex-col gap-2`}>
        <div className={`flex flex-nowrap gap-2 justify-center items-center`}>
          ...
          <span className="max-h-min font-bold uppercase text-6xl text-primary bg-secondary rounded-lg p-1">Costs!</span>
        </div>
